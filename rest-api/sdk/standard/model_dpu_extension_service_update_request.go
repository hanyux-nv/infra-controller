...
type DpuExtensionServiceUpdateRequest struct {
	...
	// Deployment spec for the DPU Extension Service, limited to 131072 bytes once UTF-8 encoded; characters outside ASCII count as more than one byte. For KubernetesPod this is the same Pod manifest accepted on create. For DpfHelmChart this is the same strict JSON definition and serviceDaemonSet validation accepted on create, and updates stable V1 in place.
